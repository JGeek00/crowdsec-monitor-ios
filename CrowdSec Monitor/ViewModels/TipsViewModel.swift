...
@MainActor
@Observable
class TipsViewModel: NSObject, SKProductsRequestDelegate, SKPaymentTransactionObserver, @unchecked Sendable {
    ...
    nonisolated private func completeTransaction(_ transaction: SKPaymentTransaction) {
        Task { @MainActor in
    ...
    nonisolated private func failedTransaction(_ transaction: SKPaymentTransaction) {
        Task { @MainActor in
    ...
    nonisolated private func restoreTransaction(_ transaction: SKPaymentTransaction) {
        Task { @MainActor in
