...
struct AllowlistsListResponse: Codable, Hashable, Sendable {
    let data: [AllowlistsListResponse_Allowlist]
    let length: Int
}

// MARK: - AllowlistsListResponse_Allowlist
struct AllowlistsListResponse_Allowlist: Codable, Hashable, Sendable {
...
struct AllowlistsListResponse_Allowlist_Item: Codable, Hashable, Sendable {
